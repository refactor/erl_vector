...
* Description: used to choose vsectionf256.h: by compiler parameter: -mavx or -mavx2
...
#if INSTRSET >= 7
  #include "vsectionf256.h"    // 256-bit floating point vectors, requires AVX instruction set
#else
